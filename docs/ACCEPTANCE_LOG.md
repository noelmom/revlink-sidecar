# ESP32-P4 hardware acceptance log

> **These are dated records, not current state.** Each entry describes what was
> observed on a bench on the day it was written, against the build of that day.
> Where an entry says a capability is unavailable, pending, or awaiting
> acceptance, that was true when it was written and may not be true now — map
> writes and deletion, for example, both shipped afterwards.
>
> For what the firmware does today, read
> [`SAFETY.md`](../SAFETY.md) for the gates,
> [`../README.md`](../README.md) for the product, and
> [`../firmware/esp32p4/README.md`](../firmware/esp32p4/README.md) for how to
> build and flash it. Nothing in this file should be read as a statement about
> the shipped image.
>
> It is kept because the reasoning is worth more than the conclusions: several
> of these entries record a theory that turned out to be wrong, and why.
